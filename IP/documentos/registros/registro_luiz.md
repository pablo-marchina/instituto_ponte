...
### Objetivo do Dia
Estrutura e pesquisa do template do wireframe do coordenador.

### Alteração
Terminei a estrutura e pesquisa do template do wireframe do coordenador.

### Links
- **Wireframe do Coordenador (Docs):** [Documento com as telas](https://docs.google.com/document/d/1adqqXx2N4uJE0ki3xl4QfUgMcVTBYQD7d1hoESxnQkk/edit?tab=t.0)
...
### Objetivo do Dia
Começar a fazer o wireframe do coordenador.

### Alteração
Fiz duas telas do coordenador e também os componentes.

### Links
- **Wireframe do Coordenador (Figma):** [Telas iniciais](https://www.figma.com/design/hT0ZlGn9DAz64Y1gIwFVrM/Sem-t%C3%ADtulo?node-id=14-210&t=OCfeOvomQASkDiGU-1)
...
### Objetivo do Dia
Continuar fazendo as telas do wireframe do coordenador.
...
### Objetivo do Dia
Avançar nas telas do wireframe do coordenador.

### Alteração
Mais 2 telas e respectivos componentes foram criados.

### Links
- **Figma geral do projeto:** [corrije-ai](https://www.figma.com/design/hT0ZlGn9DAz64Y1gIwFVrM/corrije-ai?node-id=0-1&p=f&t=yiozHSv70VPvzseF-0)
...
### Objetivo do Dia
Criar mais telas e componentes no wireframe do coordenador.

### Alteração
Foi criada mais 1 tela e muitos componentes.
...
### Objetivo do Dia
Acabar o wireframe do coordenador. Solicitar revisões, ajustar registro e revisar Joana.

### Alteração
Avançou porém falta pouco — 3 telas foram criadas.
...
### Objetivo do Dia
Finalizar o wireframe do coordenador e adicioná-lo ao WAD do projeto.

### Alteração
Wireframe do coordenador finalizado e inserido no WAD do projeto. ✅
...
| Data | Atividade |
|------|-----------|
| 06/05 | Estruturou o template do wireframe do coordenador |
| 07/05 | Fez 2 telas + componentes (login, cadastro) |
| 11/05 | Continuou as telas do coordenador |
| 12/05 | Mais 2 telas e componentes criados |
