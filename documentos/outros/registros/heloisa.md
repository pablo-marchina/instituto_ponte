...
Heloisa: Criação do rascunho dos uml da prova
...
Terminei o diagrama da prova no modelo UML
...
https://drive.google.com/drive/folders/10WWE-NGI_FWsrd9DImUuJKm3mLXaZSVB?usp=sharing
...
- Alteração: Foi criado o arquivo migration.sql com toda a relação das tabelas e demonstração do código e o modelo relacional de código do banco de dados e coloca sua descrição e detalhamento no wad 3.6.3
...
- Alteração: Atualização dos requisitos funcionais, agora sendo considerados todas as etapas do projeto e o desenvolvimento mais aprofundado do projeto. E atualização da matriz RF->RN->endpoint, atualizando os endpoint para condizer com o resto do projeto.
...
Heloísa: atualizar o diagrama de sequênciae o modelo relacional e o físico.
